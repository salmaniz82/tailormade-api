...
class Helpers
{
    ...
    public static function dataLoop(array $dataforLoop, $callback)
    {
    ...
    public static function ddx($var)
    {
        echo "<pre>";
    ...
    public static function prx($var)
    {
        echo "<pre>";
    ...
    public static function buildQueryParams(array $args)
    {
    ...
    public static function htmlSafeOutput($text)
    {
        return htmlspecialchars($text, ENT_QUOTES, 'UTF-8');
    }

    public static function x_safe_html($data)
    {
        // Fix &entity\n;
